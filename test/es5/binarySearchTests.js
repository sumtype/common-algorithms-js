...
describe('Binary Search ES5 Algorithm: binarySearch(input, value)', function () {
  ...
  it('Should return -1 when the specified value does not exist in the input array of numbers ordered from low to high.', function () {
